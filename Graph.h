...
// Large number is used to set initial weights.
// Weights of the edges are to be guaranteed to not exceed this value
...
struct DistanceVertexIdPair
{
    ...
    bool operator< (const DistanceVertexIdPair& p) const
    {
        ...
        // "proper" way to use priority_queue is to change its third
