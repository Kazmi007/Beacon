...
// Only first 100 primes are defined, use cases should not exceed the maximum
// prime in this table
...
class KeyedHashTable
{
    private:
        ...
        // Rehashes the entire table to the new expanded table
        void                        ReHash();
    ...
    public:
        ...
        // Does NOT deallocate memory though
        void                    ClearTable();
